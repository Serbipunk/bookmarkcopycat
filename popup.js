...
function copyBookmarkLocally(bookmarkTreeNodes) {
  var json_str = dumpBookmarks(bookmarkTreeNodes);
  
  var blob = new Blob([json_str], {type: "text/plain;charset=utf-8"});
  saveAs(blob, "bookmark_data.json");
}
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  chrome.bookmarks.getTree(
    function(bookmarkTreeNodes) {
      ...
      copyBookmarkLocally( bookmarkTreeNodes );
